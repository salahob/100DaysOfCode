...
firstIn = input("You're at a cross road. Where do you want to go?\n\tType \"left\" or \"right\"\n").lower()


  
if (firstIn == "left"):
  
  secondIn = input('You\'ve come to a lake. There is an island in the middle of the lake.\n\tType "wait" to wait for a boat. Type "swim" to swim across.\n').lower()

  if (secondIn == "wait"):
    
    thirdIn = input('You arrive at the island unharmed. There is a house with 3 doors.\n\tOne red, one yellow and one blue. Which colour do you choose?\n').lower()
